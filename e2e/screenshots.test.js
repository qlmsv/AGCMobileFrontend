...
describe('App Store Screenshots', () => {
    beforeAll(async () => {
        ...
        try {
            execSync('xcrun simctl status_bar booted override --time "9:41" --batteryState charged --batteryLevel 100');
        } catch (e) {
    ...
    it('should navigate and take screenshots', async () => {
        ...
        try {
            ...
            await waitFor(element(by.id('courses-screen'))).toBeVisible().withTimeout(10000);
            ...
            try {
                await waitFor(element(by.id('course-card-0'))).toBeVisible().withTimeout(10000);
        ...
        try {
            ...
            await waitFor(element(by.text('Create chat'))).toBeVisible().withTimeout(15000);
