            ...
            >
                ...
                >
                    ...
                    <View style={styles.statusRow}>
                        ...
                        <TouchableOpacity
                            style={[styles.statusButton, status === 'published' && styles.statusButtonActiveGreen]}
...
const styles = StyleSheet.create({
    ...
    label: { ...textStyles.bodyLarge, fontWeight: '600', color: colors.text.primary, marginTop: spacing.md, marginBottom: spacing.sm },
    input: {
